...
public class FavoriteProvider extends ContentProvider {
    ...
    static {
        sUriMatcher.addURI(DatabaseContract.AUTHORITY, DatabaseContract.TABLE_NAME, FAVORITE);
        sUriMatcher.addURI(DatabaseContract.AUTHORITY, DatabaseContract.TABLE_NAME + "/#", FAVORITE_ID);
    }
